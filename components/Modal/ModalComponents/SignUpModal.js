...
export default function SignUpModal() {
  return (
    <div className="relative sign-up-modal overflow-hidden gap-7 px-6 mx-4 flex flex-col pt-16 pb-32 rounded-card items-center text-center shadow">
      ...
      <PawDrawing className="absolute z-[5] w-72 -bottom-16 -right-16 p-0 opacity-80" />
    </div>
  )
}
